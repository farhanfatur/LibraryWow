                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
                            <form method="POST" action="lib/proses.php" class="form-login">
                                <div class="card card-login card-hidden">
                                    <div class="card-header text-center" data-background-color="rose">
                                        <h4 class="card-title">Login</h4>
                                    </div>
                                    <p class="category text-center">
                                        Selamat Datang di Perpustakaan_w
                                    </p>
                                    <div id="errMsg" class="alert alert-danger hide">
                                        <p>E-mail atau password anda salah!</p>
                                    </div>
                                    ...
                                    <div class="footer text-center">
                                        <button type="button" class="btn btn-rose btn-simple btn-wd btn-lg btn-submit">Masuk</button>
                                    </div>
                                </div>
                            </form>
                        </div>
            ...
            <footer class="footer">
                <div class="container">
                    <p class="copyright pull-right">
                        ...
                        <a href="#"> SNT KANESA </a>, Farhan Fatur Rozzi
                    </p>
                </div>
            </footer>
        </div>
